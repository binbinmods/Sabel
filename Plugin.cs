...
namespace Sabel
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Sabel";
        public static string heroName = characterName;

        public static string subclassName = "Sufferer"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Sabel, the Sufferer.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Sabel",
                _contentFolder: "Sabel",
